...
$(function () {
    ...
    $("#btn_delete").click(function (){
        ...
        if(temp.length<=0) {
            ...
            for(var i=0;i<temp.length;i++){
               /* putTemp[i]=temp[i].id;
                var aa = temp[i].id;*/
                bb =bb+ "ids="+temp[i].studentId+"&";
            }
            bb = bb.substr(0,bb.length-1);
            console.log(bb);
            $.ajax({
                type: "DELETE",
                url: "/student/stuDeletes"+"?"+ bb,
               /* data: {"ids": bb},*/
                dataType: "json",
    ...
    $("#btn_submit").click(function (){
        ...
        if(validateAddForm(studentName,classId,password,repassword)){
            console.log("add");
            $.ajax({
                type: "post",
                url: '/student/add',
...
var TableInit = function () {
    ...
    $("#btn_query").click(function (){
        ...
        studentName = $("#searName").val();
        studentId = $("#searNo").val();
